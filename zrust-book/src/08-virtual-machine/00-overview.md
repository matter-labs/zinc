...
ZRust code is compiled into bytecode which can be run by ZRust VM.

ZRust VM is a virtual machine that serves three purposes: executing arbitrary
...
ZRust VM is a stack-based virtual machine which is similar to many others like
