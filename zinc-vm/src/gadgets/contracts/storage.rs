...
fn alloc_leaf_fields<E, CS>(mut cs: CS, leaf_value: &[Option<E::Fr>]) -> Result<Vec<Scalar<E>>>
where
    E: Engine,
...
fn alloc_leaf_hash<E, CS>(mut cs: CS, leaf_hash_value: &[Option<bool>]) -> Result<Vec<Boolean>>
where
    E: Engine,
    CS: ConstraintSystem<E>,
{
...
impl<E: Engine, S: MerkleTreeStorage<E>, H: MerkleTreeHasher<E>> StorageGadget<E, S, H> {
    ...
    pub fn root_hash(&self) -> Result<Scalar<E>> {
