        ...
        let expected = Ok((
            ImplStatement::new(
                ...
                vec![ImplementationLocalStatement::Fn(FnStatement::new(
                    ...
                    BlockExpression::new(Location::new(3, 33), false, vec![], None),
                    vec![],
                ))],
            ),
            None,
            ...
            ImplStatement::new(
                ...
                vec![
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        ...
                        BlockExpression::new(Location::new(3, 34), false, vec![], None),
                        vec![],
                    )),
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        Location::new(5, 9),
                        ...
                        BlockExpression::new(Location::new(5, 34), false, vec![], None),
                        vec![],
                    )),
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        Location::new(7, 9),
                        ...
                        BlockExpression::new(Location::new(7, 34), false, vec![], None),
                        vec![],
                    )),
                ],
            ),
            ...
            ImplStatement::new(
                ...
                vec![
                    ...
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        ...
                        BlockExpression::new(Location::new(5, 33), false, vec![], None),
                        vec![],
                    )),
                ],
            ),
            ...
            ImplStatement::new(
                ...
                vec![
                    ...
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        ...
                        BlockExpression::new(Location::new(9, 34), false, vec![], None),
                        vec![],
                    )),
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        Location::new(11, 9),
                        ...
                        BlockExpression::new(Location::new(11, 34), false, vec![], None),
                        vec![],
                    )),
                    ImplementationLocalStatement::Fn(FnStatement::new(
                        Location::new(13, 9),
                        ...
                        BlockExpression::new(Location::new(13, 34), false, vec![], None),
                        vec![],
                    )),
                ],
            ),
