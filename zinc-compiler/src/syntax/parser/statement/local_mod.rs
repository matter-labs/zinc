    ...
    fn ok_fn_public() {
        ...
        let expected = Ok((
            ModuleLocalStatement::Fn(FnStatement::new(
                ...
                BlockExpression::new(Location::new(1, 29), false, vec![], None),
                vec![],
            )),
            None,
        ));
    ...
    fn ok_fn_constant() {
        ...
        let expected = Ok((
            ModuleLocalStatement::Fn(FnStatement::new(
                ...
                BlockExpression::new(Location::new(1, 31), false, vec![], None),
                vec![],
            )),
            None,
        ));
    ...
    fn ok_fn_public_constant() {
        ...
        let expected = Ok((
            ModuleLocalStatement::Fn(FnStatement::new(
                ...
                BlockExpression::new(Location::new(1, 35), false, vec![], None),
                vec![],
            )),
            None,
        ));
...
"#;
        ...
        let expected = Ok((
            ModuleLocalStatement::Fn(FnStatement::new(
                ...
                vec![],
                None,
                BlockExpression::new(Location::new(3, 11), false, vec![], None),
                vec![Attribute::new(
                    Location::new(2, 1),
                    false,
...
"#;
        ...
        let expected = Ok((
            ModuleLocalStatement::Fn(FnStatement::new(
                ...
                vec![],
                None,
                BlockExpression::new(Location::new(5, 11), false, vec![], None),
                vec![
                    Attribute::new(
                        Location::new(2, 1),
                        false,
