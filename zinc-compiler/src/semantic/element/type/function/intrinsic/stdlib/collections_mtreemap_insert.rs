//!
//! The semantic analyzer standard library `std::collections::MTreeMap::insert` function element.
//!
...
impl Default for Function {
    fn default() -> Self {
        Self {
            location: None,
            library_identifier: LibraryFunctionIdentifier::CollectionsMTreeMapInsert,
...
impl Function {
    /// The function identifier.
    pub const IDENTIFIER: &'static str = "insert";
    ...
    pub const ARGUMENT_INDEX_VALUE: usize = 2;
...
impl fmt::Display for Function {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "collections::MTreeMap<K, V>::{}(key: K, value: V) -> (V, bool)",
            self.identifier
        )
    }
}
