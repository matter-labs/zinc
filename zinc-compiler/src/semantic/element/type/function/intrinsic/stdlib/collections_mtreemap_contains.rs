//!
//! The semantic analyzer standard library `std::collections::MTreeMap::contains` function element.
//!
...
impl Default for Function {
    fn default() -> Self {
        Self {
            location: None,
            library_identifier: LibraryFunctionIdentifier::CollectionsMTreeMapContains,
...
impl Function {
    /// The function identifier.
    pub const IDENTIFIER: &'static str = "contains";
    ...
    pub fn call(self, location: Location, argument_list: ArgumentList) -> Result<Type, Error> {
        ...
        let (key_type, _value_type) = match actual_params.get(Self::ARGUMENT_INDEX_SELF) {
...
impl fmt::Display for Function {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "collections::MTreeMap<K, V>::{}(key: K) -> bool",
            self.identifier
        )
    }
}
