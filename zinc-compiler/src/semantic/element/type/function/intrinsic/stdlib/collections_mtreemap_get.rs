//!
//! The semantic analyzer standard library `std::collections::MTreeMap::get` function element.
//!
...
impl Default for Function {
    fn default() -> Self {
        Self {
            location: None,
            library_identifier: LibraryFunctionIdentifier::CollectionsMTreeMapGet,
...
impl Function {
    /// The function identifier.
    pub const IDENTIFIER: &'static str = "get";
