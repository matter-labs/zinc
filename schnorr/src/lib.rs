...
pub fn generate_signature<E: jubjub::JubjubEngine>(params: &E::Params, key: &eddsa::PrivateKey<E>, message: &[u8]) -> eddsa::Signature<E> {
    let mut rng = rand::OsRng::new().expect("failed to open randomness source");
...
pub fn recover_public_key<E: jubjub::JubjubEngine>(params: &E::Params, private_key: &eddsa::PrivateKey<E>) -> eddsa::PublicKey<E> {
    let p_g = jubjub::FixedGenerators::SpendingKeyGenerator;
